...
# Hardcoded subcategory URLs for Korean Beauty Group 3
SUBCATEGORY_URLS = [
    # --- merged from original sub5 ---
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/face-wipes/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/skin-care-value-gift-sets/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/body-wash-shower-gel/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/body-scrubs-exfoliators/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/body-lotion-oils/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/body-treatments/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/hand-cream-foot-cream/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/bath-body-value-gift-sets/l/",
    # --- merged from original sub6 ---
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/hair-shampoo/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/hair-mask/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/hair-oil/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/hair-treatments/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/hair-serum/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/hair-spray/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/hair-balms-creams/l/",
    "https://www.boutiqaat.com/ar-kw/women/korean-beauty/sets-kits/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/korean-beauty/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/korean-beauty/excel-files"
            )
